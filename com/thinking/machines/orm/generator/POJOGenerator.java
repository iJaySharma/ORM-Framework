...
else if(columnDataType.equalsIgnoreCase("decimal")) filteredColumnDataType="java.math.BigDecimal";
else if(columnDataType.equalsIgnoreCase("char") || columnDataType.equalsIgnoreCase("varchar")) filteredColumnDataType="String";
else if(columnDataType.equalsIgnoreCase("long") || columnDataType.equalsIgnoreCase("bigint")) filteredColumnDataType="Long";
else if(columnDataType.equalsIgnoreCase("date")) filteredColumnDataType="java.sql.Date";
else if(columnDataType.equalsIgnoreCase("tinyint")) filteredColumnDataType="Boolean";
else if(columnDataType.equalsIgnoreCase("bit")) filteredColumnDataType="Boolean";
...
sb.append("import com.thinking.machines.orm.annotation.*;");
sb.append("\r\n");
